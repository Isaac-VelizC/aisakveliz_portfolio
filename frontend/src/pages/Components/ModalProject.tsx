...
const ModalProject: React.FC<Props> = ({ selectedProject, setSelectedProject }) => {
  return (
      <AnimatePresence>
        {selectedProject && (
          <motion.div
            ...
            >
              <div className="flex justify-between items-start mb-6">
                <div>
                  ...
                  <span className={`text-sm px-3 py-1 rounded-full font-medium ${getStatusColor(selectedProject.status)}`}>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <h4 className="text-lg font-semibold text-accentcolor">Descripción</h4>
                ...
                <div className="space-y-6">
                  <div>
                    <h4 className="text-lg font-semibold text-accentcolor mb-3">Tecnologías</h4>
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-accentcolor mb-3">Estadísticas</h4>
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        <span className="text-textmuted">Stars</span>
                        <span className="text-textlight">{selectedProject.stars}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-textmuted">Vistas</span>
                        <span className="text-textlight">{selectedProject.views}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-textmuted">Fecha</span>
                        <span className="text-textlight">{selectedProject.created_at}</span>
                      </div>
                    </div>
                  </div>
